@echo off
REM Script para gerar instalador MSI usando jpackage
echo ========================================
echo   CRIANDO INSTALADOR MSI - JPACKAGE
echo ========================================
...
echo    Tipo: MSI (Windows Installer)
echo.

REM Gerar o instalador MSI
...
if %errorlevel% equ 0 (
    echo.
    echo ✅ SUCESSO! Instalador MSI criado!
    echo.
    echo 📍 Localização: target\installer\Agendador de Sinais-1.0.0.msi
    echo 📏 Tamanho: 
    for %%I in ("target\installer\*.msi") do echo    %%~zI bytes
    echo.
